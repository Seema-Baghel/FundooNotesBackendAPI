...
import com.fundoonotes.exception.EmailSendingException;
...
public class MailServiceUtility {
	...
	private boolean sendMail(String toEmailId, String subject, String bodyContaint) {
		Authenticator authentication = new Authenticator() {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication(Constants.SENDER_EMAIL_ID, Constants.SENDER_PASSWORD);
			}
		};
	...
	private MimeMessage mimeMessageConfiguration(Session session, String toEmail, String subject, String body) {
		...
		try {
			...
			mimeMessage.setFrom(new InternetAddress(Constants.SENDER_EMAIL_ID, "Registration link"));
			mimeMessage.setReplyTo(InternetAddress.parse(Constants.SENDER_EMAIL_ID, false));
